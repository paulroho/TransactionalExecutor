...
## Preparation
* Copy the class modules `AT_TransactionalExecutor` and `AT_ErrorState` (folder [TransactionalExecutorCreator.accdb.Content/Code/AT](TransactionalExecutorCreater.accdb.Content/Code/AT)) to your VBA project.
